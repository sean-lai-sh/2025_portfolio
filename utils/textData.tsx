export const experienceData = {
    ...
    NYUSEI :{
        ...
        skills: ['Python', 'Tensorflow','Data Analysis', 'Data Visualization'],
        shortDescript: 'Researched solutions and sentiment to proposed curriculum change'
    },
    Uber: {
        role: "Data Analyst, Work Experience Program @ Uber",
        date: "Dec 2021- Jan 2022",
        skills: ['Excel', 'Data Analysis', 'Data Visualization'],
        shortDescript: 'Preparing case for target market to test UberTeens product'
    }
}
